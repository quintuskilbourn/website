...
It's a secure, performant, and globally distributed network for collaborative Ethereum block building. Transactions remain provably private, and MEV value is permissionlessly redistributed to users.
...
4. Transactions remain provably private through builder nodes running in Trusted Execution Environments (TEEs).
